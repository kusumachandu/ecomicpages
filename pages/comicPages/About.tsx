        ...
        <div className="bg-black h-screen">
            ...
            <div className="flex gap-5 pt-10 text-center">
                <div className="w-[43%] h-[640px]  text-white">
                    <div className="">
                        <div>
                            <h1 className="font-extrabold text-[50px] sm:text-[30px] font-inter">ABOUT OUR PROJECT</h1>
                        </div>
                        <div className="px-28 sm:px-10 pt-5 text-yellow-100">
                        ...
                        <div className="h-[350px] sm:h-[300px] w-[450px] sm:w-[250px] relative border-red-300 m-auto">
                            <div className=" absolute w-[150px] sm:w-[100px] h-[230px] sm:h-[170px] rounded-lg mt-[13%] sm:mt-[20%] ml-[45%] sm:ml-[46%] rotate-[13deg] sm:rotate-[20deg]">
                            ...
                            <div className="w-[150px] sm:w-[100px] h-[230px] sm:h-[170px] absolute rounded-lg mt-[13.5%] sm:mt-[20%] ml-[22%] sm:ml-[8%] rotate-[347deg] sm:rotate-[340deg]">
                                <img className="w-[100%] h-[100%] rounded-lg transition-all delay-150 hover:scale-105" src="https://i.pinimg.com/474x/f0/ba/ac/f0baac2ce75266bc16992079da60d441.jpg" />
                            </div>
                            <div className="w-[150px] sm:w-[120px] absolute h-[250px] sm:h-[190px] mt-[10%] sm:mt-[15%] ml-[33.5%] sm:ml-[23%] rounded-lg m-auto">
                        ...
                        <div className="flex justify-between w-[400px] sm:w-[250px] m-auto font-desc">
                            <button className="border-2 border-yellow-200 bg-yellow-200 text-black font-bold w-44 sm:w-24 rounded-lg transition-all active:scale-95">PRE-ORDER</button>
                            <button className="border-2 border-yellow-200 text-yellow-200 font-desc font-bold w-44 sm:w-24 py-2 rounded-lg transition-all active:scale-95">WATCH DECK</button>
                        </div>
                        <div className="flex w-[400px] sm:w-[200px] py-16 m-auto justify-between ">
                            <div>
                                <svg className="cursor-pointer active:scale-95 sm:w-[20px] sm:h-[20px]" viewBox="0 0 24 24" opacity={0.5} width="28" height="28" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1"><path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"></path></svg>
                            </div>
                            <div>

    ...
    return (
        ...
        <div className="bg-black h-screen rounded-lg" style={{backgroundImage : `url('/bgimg1.png')`}}>;
            ...
            <div className="pt-10 px-5 ">
                <div className="hovershake topslide1 w-52 h-[250px] mt-12 rounded-lg shadow-xl ">
                ...
                <div className="hovershake topslide3  mt-[24px] rounded-lg shadow-xl">
                ...
                <div className="hovershake topslide5  rounded-lg shadow-xl">
                ...
                <div className="hovershake topslide7 mt-[24px] rounded-lg shadow-xl">
                ...
                <div className=" hovershake topslide8 mt-12 rounded-lg shadow-xl">

...
export default function ErrorPage() {
    return (
        ...
        <div className="bg-black h-screen rounded-lg" style={{ backgroundImage: `url('https://www.dc.com/sites/default/files/Char_Gallery_Batman_DTC1018_6053f2162bdf03.97426416.jpg')`}}>
            <Navbar />
